...
public class RobotMap {
    ...
    public static void init() {
        ...
        drivetrainRightMotor = new VictorSP(2);
        drivetrainRightMotor.setInverted(true);
        LiveWindow.addActuator("Drivetrain", "Right Motor", (VictorSP) drivetrainRightMotor);
        
        drivetrainLeftMotorBack = new VictorSP(1);
        drivetrainLeftMotorBack.setInverted(true);
        ...
        drivetrainRightMotorBack.setInverted(true);
